  ...
  <table class="w-full">
    ...
    <thead>
      <tr class="h-12">
        ...
        <th class="border-solid border-2 border-green-500 bg-green-200 w-3/12">Nama Karyawan</th>
        <th class="border-solid border-2 border-green-500 bg-green-200 w-3/12">Alamat </th>
        <th class="border-solid border-2 border-green-500 bg-green-200 w-2/12">Telepon</th>
    ...
    <tbody>
      @foreach ($result->karyawan as $output)
        <tr>
          ...
          <td class="border-solid border-2 border-green-500 bg-transparent text-justify px-2.5">{{ $output->nama_karyawan }}</td>
          <td class="border-solid border-2 border-green-500 bg-transparent text-justify px-2.5">{{ $output->alamat_karyawan }}</td>
          <td class="border-solid border-2 border-green-500 bg-transparent text-center px-2.5">{{ $output->telepon_karyawan }}</td>
          <td class="border-solid border-2 border-green-500 bg-transparent text-justify px-2.5">{{ $output->jabatan_karyawan }}</td>
        </tr>
      @endforeach
    </tbody>
  </table>
